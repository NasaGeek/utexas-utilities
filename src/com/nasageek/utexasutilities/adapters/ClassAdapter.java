...
public class ClassAdapter extends BaseAdapter {
    ...
    public ClassAdapter(Context c, WrappingSlidingDrawer wsd, LinearLayout llsd, ImageView ci_iv,
            TextView ci_tv, String semId, ArrayList<UTClass> classList) {
            ...
            switch (ct.getDay()) {
                ...
                case 'T':
                    for (int a = 0; a < (endpos - startpos); a++) {
                        ...
                        if (a == 0) {
                            firstlist.set(1 + 5 * startpos + a * 5, true);
                        }
                    }
                    break;
                // TODO: 2+5*startpos+a*5 == -9 ? getting an exception from
                // someone
                case 'W':
                    for (int a = 0; a < (endpos - startpos); a++) {
                        cllist.set(2 + 5 * startpos + a * 5, ct);
                        if (a == 0) {
                            firstlist.set(2 + 5 * startpos + a * 5, true);
                        }
                    }
                    break;
                case 'H':
                    for (int a = 0; a < (endpos - startpos); a++) {
                        ...
                        if (a == 0) {
                            firstlist.set(3 + 5 * startpos + a * 5, true);
                        }
                    }
                    break;
                case 'F':
                    for (int a = 0; a < (endpos - startpos); a++) {
                        ...
                        if (a == 0) {
                            firstlist.set(4 + 5 * startpos + a * 5, true);
                        }
                    }
                    break;
            }
    ...
    public void updateTime() {
        ...
        time = cal.get(Calendar.HOUR) + (cal.get(Calendar.MINUTE) >= 30 ? ":30" : ":00")
