...
public class saveBooks extends SherlockActivity {
...
//		dialog = ProgressDialog.show(this, "", "Loading. Please wait...", true);
	...
	/*	ActionBar actionBar = (ActionBar) findViewById(R.id.actionbar);
		...
		actionBar.addAction(new IntentAction(context, new Intent(context, settings.class), R.drawable.ic_menu_preferences)); //go to settings
		//----------------------*/
