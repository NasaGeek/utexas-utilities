...
public class LoginActivity extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	case 'c':wv.loadUrl("https://utexas.instructure.com/login/oauth2/auth?client_id=10000000000228&response_type=code&redirect_uri=urn:ietf:wg:oauth:2.0:oob&mobile=1");
    			 wv.getSettings().setJavaScriptEnabled(true);
    			 actionbar.setSubtitle("Canvas one-time authorization");break;
    	}
    	setContentView(wv);
    }
    @Override
