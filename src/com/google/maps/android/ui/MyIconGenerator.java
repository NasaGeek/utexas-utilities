//hiding in this package to get access to package-local classes
...
public class MyIconGenerator {
    ...
    private static int getBackground(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return com.nasageek.utexasutilities.R.drawable.bubble_white;
            case STYLE_RED:
                return com.nasageek.utexasutilities.R.drawable.bubble_red;
            case STYLE_BLUE:
                return com.nasageek.utexasutilities.R.drawable.bubble_blue;
            case STYLE_GREEN:
                return com.nasageek.utexasutilities.R.drawable.bubble_green;
            case STYLE_PURPLE:
                return com.nasageek.utexasutilities.R.drawable.bubble_purple;
            case STYLE_ORANGE:
                return com.nasageek.utexasutilities.R.drawable.bubble_orange;
        }
    }
    ...
    private static int getTextStyle(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return com.nasageek.utexasutilities.R.style.Bubble_TextAppearance_Dark;
            case STYLE_RED:
            case STYLE_BLUE:
            case STYLE_GREEN:
            case STYLE_PURPLE:
            case STYLE_ORANGE:
                return com.nasageek.utexasutilities.R.style.Bubble_TextAppearance_Light;
        }
    }
}